...
def run_experiment(
    ...
    with open(csv_output, "w", newline="") as f:
        ...
        header = [
            ...
            "prosetrior_probability", "max_logit", "mean_logit_margin", "logit_variance",
        ...
        for idx, example in enumerate(data):
            ...
            for i, (actual, mispronounced) in enumerate(zip(actual_phonemes, mispronounced_phonemes)):
                ...
                writer.writerow([
                    ...
                    s["end_time"],
                    s["conf"],
                    metrics["prosetrior_probability"], metrics["max_logit"], metrics["mean_logit_margin"], metrics["logit_variance"],
